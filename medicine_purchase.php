...
if(isset($_POST["add_medicine_purchase"]))
{
    ...
    if(empty($_POST["medicine_whole_sale_price_per_unit"]))
    {
        $error .= '<li>Whole Sale Price per unit is required</li>';
    }
    else
    {
        $formdata['medicine_whole_sale_price_per_unit'] = trim($_POST["medicine_whole_sale_price_per_unit"]);
    }
...
if(isset($_POST["edit_medicine_purchase"]))
{
    ...
    if($error == '')
    {
        ...
        $object->query = "
            ...
            medicine_whole_sale_price_per_unit = :medicine_whole_sale_price_per_unit , 
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3">
                                                    ...
                                                    <label for="medicine_sale_price_per_unit">Retail Sale Price per Unit</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        <div class="col-md-6">
                                                <div class="form-floating mb-3">
                                                    <input class="form-control" id="medicine_whole_sale_price_per_unit" type="number" placeholder="Enter Whole Sale Price per Unit" name="medicine_whole_sale_price_per_unit" step=".01" value="<?php if(isset($_POST["medicine_whole_sale_price_per_unit"])) echo $_POST["medicine_whole_sale_price_per_unit"]; ?>" />
                                                    <label for="medicine_sale_price_per_unit">Whole Sale Price per Unit</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-4 mb-0">
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                <div class="form-floating mb-3">
                                                        <input class="form-control" id="medicine_whole_sale_price_per_unit" type="number" placeholder="Enter Whole Sale Price per Unit" name="medicine_whole_sale_price_per_unit" step=".01" value="<?php echo $medicine_purchase_row["medicine_whole_sale_price_per_unit"]; ?>" />
                                                        <label for="medicine_whole_sale_price_per_unit">Whole Sale Price per Unit</label>
                                                    </div>
                                    ...
                                    <table id="datatablesSimple">
                                        ...
                                        foreach($result as $row)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>'.$object->cur_sym . $row["medicine_whole_sale_price_per_unit"].'</td>
